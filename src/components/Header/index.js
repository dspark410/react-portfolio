      ...
      <div className='mainsummary-container'>
        <div className='summary-container'>
          <p
            ...
            className='summary'
            data-aos='fade'>
            Hey! My name is David and I'm a web developer with a passion for the
            front end. I'm a bootcamp graduate from the UC Berkeley Extension
            Full Stack Web Development Program looking for opportunities in
