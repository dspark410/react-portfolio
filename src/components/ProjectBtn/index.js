      ...
      <Collapse in={expanded} timeout={800} unmountOnExit>
        <div className='card-container'>
          <div className='card-body'>
            ...
            <a
              ...
              rel='noopener noreferrer'
            >
              <RiGithubLine style={{ fontSize: '18px', height: '18px' }} />
            </a>
          </div>
        </div>
        ...
        <div className='card-container'>
          <div className='card-body2'>
            ...
            >
              <img
                className='logo2'
                src={process.env.PUBLIC_URL + '/images/smasual.jpg'}
                alt='Smasual Logo'
              />
            </a>
            <p
            ...
            <a
              style={{ textDecoration: 'none', color: '#e91d63' }}
        ...
        <div className='card-container'>
          <div className='card-body'>
            <a
              style={{ textDecoration: 'none' }}
              href='https://staffbotsteve.github.io/lazy-loaders/'
              target='_blank'
              rel='noopener noreferrer'
            >
              <img
            ...
            <a
              style={{ textDecoration: 'none', color: '#006599' }}
              href='https://github.com/dspark410/lazy-loaders'
              target='_blank'
              rel='noopener noreferrer'
            >
              <RiGithubLine style={{ fontSize: '18px', height: '18px' }} />
