      ...
      <div className="main">
        ...
        <div className="mainsummary-container">
          <div className="summary-container">
            <p style={{color:"black", fontWeight:"bold"} }className="summary">Recent bootcamp graduate from the UC Berkeley Extension Full Stack Web Development Program</p>
          </div>
          <div className="summary-container">
            <p style={{color:"black", fontWeight:"bold"}} className="summary">During my free time I love to play video games, cook, and eat lots of food.</p>
          </div>
          <div className="summary-container">
            <p style={{color:"black", fontWeight:"bold"}} className="summary">I'm also a personally certified Food Adventurer & Eater.</p>
          </div>
        </div>
